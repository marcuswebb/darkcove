var BCLSmain = (function ($, window, console, document, Handlebars, bclsNavData, hljs) {
    ...
    var $precode = $("pre code"),
        ...
        titleAreaTemplate = "<nav class=\"top-bar\" data-topbar><ul class=\"title-area\"><li class=\"name\"><a href=\"//docs.brightcove.com/en/index.html\"><img class=\"bcls-logo bcls-float-left\" src=\"//docs.brightcove.com/en/images/bc-logo-small.png\" alt=\"Brightcove\">DEVELOPER DOCS</a></li><li class=\"toggle-topbar menu-icon\"><a href=\"#\"><span>Menu</span></a></li></ul><section class=\"top-bar-section\"><ul id=\"navMenuLeft\" class=\"left\"></ul></section><section class=\"top-bar-section\"><ul id=\"navMenuRight\" class=\"right\"></ul></section></nav>",
    ...
    createNavigation = function () {
        ...
        processDropdown = function (items) {
            ...
            $navWrapper.find("ul.title-area,ul.title-area>li,ul.title-area>li>a").attr("style", "background-color:" + productColors.index + ";");
